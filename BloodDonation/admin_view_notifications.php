...
<html lang = "en">
    ...
    <body>
        ...
        while($row=mysqli_fetch_assoc($query)){
            ?>
           <tr>
               <td>We urgently require blood type <?php echo $row['bloodtype'];?>!!! Donation period is 7 days starting <?php echo $row['date'];?> at hospital <?php echo $row['hospital'];?>.</td>
               <td>
                   <a href="delete_notification.php?id=<?php echo $row['id']?>" class="link-dark"><i style="color: red;" class="fa-solid fa-trash fs-5"></i></a>
               </td>
           </tr>
                <?php
        }
