    ...
    <body>
        ...
        while($row=mysqli_fetch_assoc($query)){
           ...
           <tr>
               ...
               <td>
                   <a href="edit_user.php?uid=<?php echo $row['uid']?>" class="link-dark"><i style="color: #36AD18;" class="fa-solid fa-pen-to-square fs-5 me-3"></i></a>
                   <a href="delete_user.php?uid=<?php echo $row['uid']?>" class="link-dark"><i style="color: red;" class="fa-solid fa-trash fs-5"></i></a>
               </td>
           </tr>
                <?php
        }
