    ...
    <body>
        ...
        if (isset($_POST['submitted'])) {
            ...
            if (empty($_POST['user_name']) || empty($_POST['password'])) {
                ...
                $query = "SELECT uname, password from user where uname=? AND password=? LIMIT 1";
        ...
        <div class="container mt-4">
            ...
            <div style="background: rgba(255, 255, 255, 0.25); box-shadow: 0 25px 45px rgba(0, 0, 0, 0.2); border: 2px solid rgba(255, 255, 255, 0.5)" class="card mb-3 ms-4 me-4">
                ...
                <div class="row">
                    ...
                    <div class="col-12">
                        <h1 style="font-family: fantasy" class="text-center mt-2 text-white"><u>Sign In</u></h1>
                    </div>
                    ...
                    <p style="text-decoration:none; text-align: center; cursor: pointer;" id="admin_login" onclick="adminLoginFunc()">I am an Admin...</p>
                    </div>
