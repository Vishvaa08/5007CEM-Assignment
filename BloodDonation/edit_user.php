...
if (isset($_POST['submit'])) {
    ...
    $sql = "UPDATE user SET fname='$fname', lname='$lname', uname='$uname', email='$email', address='$address', phone='$phone', password='$password', bloodtype='$bloodtype', points='$points' WHERE uid=$uid";
    $query_run = mysqli_query($conn, $sql);

    if ($query_run) {
        header('location: admin_homepage.php?Edit Successful');
    } else {
                    ...
                    <div class="offcanvas-body">
                        <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
                            <li class="nav-item mx-2">
                                <a class="nav-link" aria-current="page" href="admin_homepage.html">Home</a>
                            </li>
            ...
            <div class="container text-center text-md-left">
                ...
                <div class="row text-center text-md-left">
                    ...
                    <div class="col-md-2 col-lg-2 col-xl-2 mx-auto mt-3">
                        ...
                        <p><a href="account.html" class="text-white" style="text-decoration: none;">Account</a></p>
                        <p><a href="notifications.html" class="text-white" style="text-decoration: none;">Notifications</a></p>
