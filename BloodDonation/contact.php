    ...
    <body>
        ...
        if (isset($_POST['submitted'])) {
            ...
            if ($okay) {
                ...
                $sql = "INSERT INTO contact (uname, email, message) VALUES ('$uname', '$email', '$message');";
        ...
        <div class="container mt-4">
            ...
            <div style="background: rgba(255, 255, 255, 0.25); box-shadow: 0 25px 45px rgba(0, 0, 0, 0.2); border: 2px solid rgba(255, 255, 255, 0.5)" class="card mb-3 ms-4 me-4">
                ...
                <div class="row">
                    ...
                    <div class="col-12">
                        <h1 style="font-family: fantasy" class="text-center mt-2 text-white"><u>Contact</u></h1>
                    </div>
                    ...
                    <p><input type = "submit" name = "submit" value = "Submit" style="background: #FF0066" class="btn col-4 col-lg-4 offset-4 text-white"/></p>   
